...
//                    let fUser = FUser(_objectId: firuser!.user.uid, _pushId: "", _createdAt: Date(), _updatedAt: Date(), _email: "", _firstname: "", _lastname: "", _avatar: "", _loginMethod: Constants.kPHONE, _phoneNumber: firuser!.user.phoneNumber!, _city: "", _country: "")
//
//                    saveUserLocally(fUser: fUser)
//                    saveUserToFirestore(fUser: fUser)
//                    completion(error, false)
